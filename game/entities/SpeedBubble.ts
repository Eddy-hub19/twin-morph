 ...
 * секунд ускоряет ходьбу/копание в SPEED_BOOST_MULTIPLIER раз (см.
 * GameScene.speedBoostEndsAt). В отличие от обычного пузырька света (Bubble — голубой, эффект постоянный),
